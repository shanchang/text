...
public class ConsumeDAO extends BaseHibernateDAO {
	...
	public Consume findById(java.sql.Timestamp id) {
	...
	public List findBySaveMoney(Object saveMoney) {
		return findByProperty(SAVE_MONEY, saveMoney);
	}

	public List findByGetMoney(Object getMoney) {
		return findByProperty(GET_MONEY, getMoney);
	}
